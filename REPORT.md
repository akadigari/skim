...
_Auto-generated 2026-08-01 09:25 UTC, **day 20.5 of 14**. 100% sim: this repo only reads public endpoints and cannot place orders._

## Health

| check | status |
|---|---|
| last checkpoint | 2026-08-01 09:25 UTC (if this is > 7.5h old, the watchdog has already alerted Telegram) |
| jobs run (6h chain) | 55 |
| current job age | 0.0h of 5.7h max |
| markets quoting / retired | 15 / 120 |
| favorites open (maker/taker/poly) | 4 / 4 / 11 |
...
| poly taker (zero-fee) | 11 | - | 251 | 222 | $-61.27 | -2.69% |
