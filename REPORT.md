...
_Auto-generated 2026-08-01 04:41 UTC, **day 20.3 of 14**. 100% sim: this repo only reads public endpoints and cannot place orders._

## Health

| check | status |
|---|---|
| last checkpoint | 2026-08-01 04:41 UTC (if this is > 7.5h old, the watchdog has already alerted Telegram) |
| jobs run (6h chain) | 54 |
| current job age | 0.0h of 5.7h max |
| markets quoting / retired | 15 / 120 |
| favorites open (maker/taker/poly) | 4 / 4 / 12 |
| API requests last job | 73 |
...
**Gate status: UNDERPOWERED**, 85/300 settled maker positions, no verdict yet (this is honest, not broken)

| variant | open | unfilled | settled | wins | P&L | cond-on-fill ROI |
|---|---|---|---|---|---|---|
| kalshi maker | 4 | 98 | 85 | 78 (win-rate CI 84%-96%) | $+8.00 | +1.05% |
| kalshi taker | 4 | - | 183 | 174 | $+31.10 | +1.83% |
| poly taker (zero-fee) | 12 | - | 250 | 221 | $-62.67 | -2.76% |
