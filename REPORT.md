...
_Auto-generated 2026-07-29 15:22 UTC, **day 17.7 of 14**. 100% sim: this repo only reads public endpoints and cannot place orders._

## Health

| check | status |
|---|---|
| last checkpoint | 2026-07-29 15:22 UTC (if this is > 7.5h old, the watchdog has already alerted Telegram) |
| jobs run (6h chain) | 44 |
| current job age | 0.0h of 5.7h max |
| markets quoting / retired | 15 / 120 |
| favorites open (maker/taker/poly) | 42 / 42 / 33 |
...
|---|---|---|---|---|---|---|
| kalshi maker | 42 | 67 | 78 | 72 (win-rate CI 84%-96%) | $+10.62 | +1.51% |
| kalshi taker | 42 | - | 145 | 138 | $+25.37 | +1.88% |
| poly taker (zero-fee) | 33 | - | 229 | 201 | $-75.25 | -3.61% |
